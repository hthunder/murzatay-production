...
export const ProfileInfo = (profileData) => {
    ...
    section.innerHTML = `
        <img class="my-page__about-avatar" src="${escape(avatar)}" alt="Ваше фото">
        <div class="my-page__about-info">
            ...
            <div class="my-page__about-fields">
                <p class="my-page__about-field my-page__about-username">Ник: ${escape(username)}</p>
                <p class="my-page__about-field my-page__about-city">Город: ${escape(city)}</p>
            ...
            <form class="my-page__about-edit-form my-page__about-edit-form_hidden">
                ...
                <label class="my-page__about-form-label">
                    Ник:
                    <input class="my-page__about-form-input" name="username" type="text" value="${escape(username)}">
                </label>
                <label class="my-page__about-form-label">
                    Город:
                    <input name="city" type="text" value="${escape(city)}" class="my-page__about-form-input">
                </label>
                <label class="my-page__about-form-label">
                        Расскажите о себе или своих питомцах:
                    <textarea maxlength="250" name="about" placeholder="Расскажите о себе или своих питомцах"
                        class="my-page__about-form-textarea textarea">${escape(about)}</textarea>
                </label>
